                            ...
                            <div id="basicwizard">
                                ...
                                <div class="tab-pane" id="media">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-xl-8">
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="course_overview_url"><?php echo get_phrase('course_overview_video'); ?></label>
                                                <div class="col-md-10">
                                                    <input type="file" class="form-control" name="course_overview_url" id="course_overview_url" placeholder="E.g: https://www.youtube.com/watch?v=oBtf8Yglw2w">
                                                </div>
                                            </div>
                                        </div> <!-- end col -->
