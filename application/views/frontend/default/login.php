<section class="category-header-area hide" style="display: none">
              ...
              <div class="user-dashboard-box mt-3">
                  <div class="user-dashboard-content w-100 login-form">
                      ...
                      <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                          ...
                          <div class="forgot-pass text-center" style="display: none">
                              <span>or</span>
                              <a href="javascript::" onclick="toggoleForm('forgot_password')"><?php echo get_phrase('forgot_password'); ?></a>
                          </div>
                          <div class="account-have text-center" style="display: none">
